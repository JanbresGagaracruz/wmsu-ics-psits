...
<head>
    ...
    <title>Promissory | Institute of computer studies</title>
</head>
<body>
    <?php
        include("header.php");
    ?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-head-line" >Promissory Approval</h2>
                    </div>
                </div>
                <center class="center">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        LEFT JOIN year_lvl
                                            ...
                                            WHERE student_assessment.promissory_approval = 'pending';    
                                        ");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" name="view"  id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view_promissory">
                                                <span class="fas fa-eye fa-2x"></span>
                                            </a> 
                                            <a href="../include/create_promissory.php?accept=<?php echo $row['id']; echo $row['email'];?>"class="btn btn-success btn-xs" type="submit"id="accept" name="accept">
                                                <span class="fas fa-check fa-2x"> </span>
                                            </a>
                                            <a href="../include/create_promissory.php?decline=<?php echo $row['id'] ?>" class="btn btn-danger btn-xs" id="decline" name="decline">
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title">Promissory details</h4>  
                </div>  
