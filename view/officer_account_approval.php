                                ...
                                <tbody>
                                    ...
                                    <tr><?php if($row['approval_status'] == 'inactive'){ ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="../include/approval.php?accept_officer=<?php echo $row['id']; echo $row['email'];?>"class="btn btn-success btn-xs" type="submit"id="accept" name="accept">
                                                <span class="fas fa-check fa-2x"> </span>
                                            </a>
                                            <a href="../include/approval.php?decline_officer=<?php echo $row['id'] ?>" class="btn btn-danger btn-xs" id="decline" name="decline">
