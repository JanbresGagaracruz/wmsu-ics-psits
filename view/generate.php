            ...
            <div id="page-inner">
                ...
                <div class="row" style="display: flex; justify-content:center;">
                    <form method="POST" action="generate.php">
                        <input type="submit" name="all_record" id="all_record"class="btn btn-danger" value="Generate All Record" />
                    </form> 
                </div>
                <div class="row" style="margin-top: 2rem;">
                <div class="col-md-4"></div>
                    <div class="col-md-4">
                        <div class="main-box mb-orange" style="padding-left: 4.4rem;">
                            <form method="POST" id="generate" action="generate.php">
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">Generate Student Reports </legend>
                                    ...
                                    <input type="submit" name="create_pdf" id="create_pdf" class="btn btn-danger" value="Generate Report" />  
                                </fieldset>
                            </form>
                        </div>
                    </div>
