...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'../assets/ics.png')) {
		$tcpdf_header_logo = '../assets/ics.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'Western Mindanao State University');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'ICS PSITS');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'PSITS Collection');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Institute of Computer Studies\n Western Midanao State University");
}
